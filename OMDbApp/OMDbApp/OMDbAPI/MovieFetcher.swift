...
private extension MovieFetcher {
    ...
    func makeSearchForMoviesComponents(withTitle title: String) -> URLComponents {
        ...
        components.scheme = OpenMoviesAPI.scheme
        components.host = OpenMoviesAPI.host
        components.path = OpenMoviesAPI.path
        
        components.queryItems = [
            URLQueryItem(name: "s", value: title),
            URLQueryItem(name: "type", value: "movie"),
            URLQueryItem(name: "apikey", value: OpenMoviesAPI.key)
        ]
